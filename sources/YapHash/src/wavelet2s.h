...
void* dwt_2d_sym(vector<vector<double> > &, int, string, vector<double> &, vector<double> &, vector<int> &);

void* dwt2_sym(string, vector<vector<double> > &, vector<vector<double> > &, vector<vector<double> > &, vector<vector<double> > &, vector<vector<double> > &);
...
void* dwt_2d(vector<vector<double> > &, int, string, vector<double> &, vector<double> &, vector<int> &);
